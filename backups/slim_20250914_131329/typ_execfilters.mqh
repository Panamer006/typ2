...
// ===== Helpers
double _atr(const string s, ENUM_TIMEFRAMES tf, int p=14)
{
...
double _dist_pips(const string s,double a,double b){ return MathAbs(a-b)/_pip(s); }
double _nearest_round(const string s,double price,double step_pips){
